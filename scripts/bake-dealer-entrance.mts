...
import {DEALER_CARD_REVEAL_START,DEALER_CARD_SNAP} from '../components/resume/casino/dealer-card-reveal'
...
writeFileSync('blender-bridge/casino-dealer-v3/entrance-timing.json',JSON.stringify({hat:DEALER_HAT_VISIBLE,cards:DEALER_CARD_ACTION_START+DEALER_CARD_REVEAL_START,cardActionStart:DEALER_CARD_ACTION_START,cardSnap:DEALER_CARD_ACTION_START+DEALER_CARD_SNAP,chip:DEALER_ENTRANCE_END+1.08,body:dealerEntranceTime(.8),end:DEALER_ENTRANCE_END}))
