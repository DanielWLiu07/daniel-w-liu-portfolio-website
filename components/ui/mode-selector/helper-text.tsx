...
export const HelperText = forwardRef<HTMLDivElement>((_, ref) => {
  return (
    ...
    >
      <p
        className={`text-sm md:text-base lg:text-base text-center max-w-[90%] md:max-w-2xl tracking-wider text-stroke-white-xs drop-shadow-lg text-[#2c1810] ${fredrick.className}`}
      >
