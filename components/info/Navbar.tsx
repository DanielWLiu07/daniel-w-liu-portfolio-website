        ...
        <nav className="fixed top-5 left-1/2 -translate-x-1/2 md:left-5 md:translate-x-0 z-[150] pointer-events-none">
            <NavigationMenu.Root className="relative z-[1] flex justify-start pointer-events-auto">
                <NavigationMenu.List className="center shadow-blackA4 m-0 flex list-none rounded-[6px] bg-white p-1 shadow-[0_2px_10px]">
                    <NavigationMenu.Item>
                        <NavigationMenu.Link 
                            className="text-gray-900 hover:bg-gray-100 focus:shadow-violet7 block select-none rounded-[4px] px-2 md:px-3 py-2 text-[13px] md:text-[15px] font-medium leading-none no-underline outline-none focus:shadow-[0_0_0_2px] transition-colors duration-200 whitespace-nowrap" 
                            href="/"
                        >
                            Daniel W Liu
                        </NavigationMenu.Link>
