...
{isLowPerformance ? (
        <>
          <section className="md:hidden relative h-screen">
            <Image src="/animation_frames/watercolour_sequences/portrait_vid/render_compositing_080.png" alt="water colour" fill className="object-cover object-[10%_100%] z-0" />
            <Image src="/animation_frames/watercolour_sequences/sparkle_loop_vid/render_compositing_250.png" alt="sparkle" fill className="object-cover object-[10%_100%] z-10" />
          </section>

          <section className="md:hidden relative h-[300vh]">
            <div className="sticky top-0 h-screen">
              <Image src="/animation_frames/watercolour_sequences/colour_vid_phone/render_compositing_080.png" alt="right colour" fill className="object-cover object-right" />
