        ...
        <div className="relative w-full min-h-screen">
            ...
            <div className="relative z-10 min-h-screen flex justify-end">
                <div className={`w-1/2 pl-10 pb-5 flex flex-col justify-start ${katieRoze.className}`}>
                        ...
                        <div className=" pl-6 text-black text-3xl font-bold drop-shadow-[0_1px_2px_rgba(0,0,0,0.2)]">
                            <div className="flex items-center gap-3">
                                <p className="text-4xl max-w-md text-stroke-white-sm">0 University of Waterloo - Computer Science and Finance Double Major (2025 - Present)</p>
                            </div>
                            <p className="text-4xl max-w-lg text-stroke-white-sm">0 45/45 Final IB Score (Top 0.1% Global)</p>
                            <p className="text-4xl max-w-lg text-stroke-white-sm">0 Fullstack and ML - Jack of All Trades</p>
                            <p className="text-4xl max-w-lg text-stroke-white-sm">0 Hobbies: Rock Climbing, Brawl Stars, Riot Games, Pingpong, Pokemon, Calisthenics, Game Dev. </p>
                        </div>
                        ...
                        <div className=" pl-6 text-black text-3xl font-bold drop-shadow-[0_1px_2px_rgba(0,0,0,0.2)] flex flex-col gap-y-4">
                            <div>
                                <p className="text-4xl mb-2 text-stroke-white-sm">0 Languages</p>
                            ...
                            <div>
                                <p className="text-4xl mb-2 text-stroke-white-sm">0 Fullstack</p>
                                <div className="flex flex-wrap gap-2">
                            ...
                            <div>
                                <p className="text-4xl mb-2 text-stroke-white-sm">0 3D</p>
                                <div className="flex flex-wrap gap-2">
                            ...
                            <div>
                                <p className="text-4xl mb-2 text-stroke-white-sm">0 Data + ML</p>
                                <div className="flex flex-wrap gap-2">
                            ...
                            <div>
                                <p className="text-4xl mb-2 text-stroke-white-sm">0 Cloud/DevOps</p>
                                <div className="flex flex-wrap gap-2">
